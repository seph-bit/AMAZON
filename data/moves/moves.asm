...
; Characteristics of each move.
	...
	move COMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  22, NORMAL,       100, 15
	move MEGA_PUNCH,   NO_ADDITIONAL_EFFECT,        80, NORMAL,        95, 20
	...
	move RAZOR_WIND,   CHARGE_EFFECT,               80, NORMAL,        95, 10
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,       100, 30
	move CUT,          NO_ADDITIONAL_EFFECT,        65, BUG,           95, 30
	...
	move MEGA_KICK,    NO_ADDITIONAL_EFFECT,       120, NORMAL,        95,  5
	move JUMP_KICK,    JUMP_KICK_EFFECT,            80, FIGHTING,     100, 25
	move ROLLING_KICK, FLINCH_SIDE_EFFECT2,         60, FIGHTING,      95, 15
	...
	move STRENGTH,     NO_ADDITIONAL_EFFECT,        80, ROCK,         100, 15
	...
	move RAZOR_LEAF,   NO_ADDITIONAL_EFFECT,        60, GRASS,         95, 25
	...
	move FIRE_SPIN,    TRAPPING_EFFECT,             15, FIRE,          75, 15
	...
	move RAGE,         RAGE_EFFECT,                 50, NORMAL,       100, 20
	...
	move LICK,         PARALYZE_SIDE_EFFECT2,       35, GHOST,        100, 30
	move SMOG,         POISON_SIDE_EFFECT2,         40, POISON,       100, 20
	move SLUDGE,       POISON_SIDE_EFFECT2,         95, POISON,       100, 20
	...
	move KINESIS,      ACCURACY_DOWN1_EFFECT,        0, PSYCHIC_TYPE,  85, 15
	move SOFTBOILED,   HEAL_EFFECT,                  0, NORMAL,       100, 10
	move HI_JUMP_KICK, JUMP_KICK_EFFECT,           120, FIGHTING,      85, 20
	move GLARE,        PARALYZE_EFFECT,              0, NORMAL,        85, 30
	...
	move LEECH_LIFE,   DRAIN_HP_EFFECT,             35, BUG,          100, 15
	move LOVELY_KISS,  SLEEP_EFFECT,                 0, NORMAL,        75, 10
	move SKY_ATTACK,   CHARGE_EFFECT,              120, FLYING,        85,  5
	move TRANSFORM,    TRANSFORM_EFFECT,             0, NORMAL,       100, 10
	move BUBBLE,       SPEED_DOWN_SIDE_EFFECT,      15, WATER,        100, 30
	move DIZZY_PUNCH,  NO_ADDITIONAL_EFFECT,        70, NORMAL,       100, 10
	move SPORE,        SLEEP_EFFECT,                 0, GRASS,        100, 15
	move FLASH,        ACCURACY_DOWN2_EFFECT,        0, ELECTRIC,      75, 20
	...
	move FURY_SWIPES,  TWO_TO_FIVE_ATTACKS_EFFECT,  30, NORMAL,       100, 15
	move BONEMERANG,   ATTACK_TWICE_EFFECT,         50, GROUND,        90, 10
	move REST,         HEAL_EFFECT,                  0, PSYCHIC_TYPE, 100, 10
	move ROCK_SLIDE,   NO_ADDITIONAL_EFFECT,        90, ROCK,          95, 10
	move HYPER_FANG,   FLINCH_SIDE_EFFECT1,         80, NORMAL,         0, 15
	move SHARPEN,      ATTACK_UP1_EFFECT,            0, NORMAL,       100, 30
	move CONVERSION,   CONVERSION_EFFECT,            0, NORMAL,       100, 30
	move TRI_ATTACK,   NO_ADDITIONAL_EFFECT,        80, NORMAL,       100, 10
	move SUPER_FANG,   SUPER_FANG_EFFECT,            1, NORMAL,        85, 10
	move SLASH,        NO_ADDITIONAL_EFFECT,        70, NORMAL,       100, 20
	move SUBSTITUTE,   SUBSTITUTE_EFFECT,            0, NORMAL,       100, 10
	move STRUGGLE,     RECOIL_EFFECT,               50, BIRF,         100, 10
